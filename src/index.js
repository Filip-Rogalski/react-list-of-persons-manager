...
class App extends Component {
    ...
    updateEditedPerson(e) {
        e.preventDefault();
        this.setState(prevState => ({ persons: prevState.persons.map(person => person[0] === this.state.editedItemId ? [this.state.editedItemId, this.state.newPersonsName, this.state.newPersonsAge] : person), editMode: 'false' }));
    }
